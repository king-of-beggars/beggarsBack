...
export class BoardService {
  ...
  async postBoard(postBoardDto: PostBoardDto): Promise<any> {
    ...
    const query = this.boardRepository.create(postBoardDto);
  ...
  async getListAll(paginationDTO: PaginationDto): Promise<BoardResDto[]> {
    const result = await this.boardRepository
      ...
      .where('board.boardTypes=:boardTypes', {
        boardTypes: paginationDTO.boardTypes,
      })
  ...
  async getDetailByBoardId(
    getByBoardIdDto: GetByBoardIdDto,
  ): Promise<Cashbook> {
